    ...
    func populateModel(){
        ...
        blobClient.listContainersSegmentedWithContinuationToken(nil) {
            ...
            if(error == nil){
                ...
                // Si no hay errores, le asigno a mi array  'model' el resultado
                // Dependiendo del tipo de llamada que hagamos nos devolverá  un
                // array con blobs, con parámetros, con  metadatos, y otro  tipo.
                // Opcional 'resultSegment', ya que no sé si obtendré resultados
                // y le hago un casting de tipo  'AZSCloudBlobContainer' también
                // opcional, ya  que no  sé tampoco  si lo podré castear al tipo.
                // Con esto ya tengo el modelo casteado a 'AZSCloudBlobContainer'
                ...
                dispatch_async(dispatch_get_main_queue(), {() -> Void in
                    // Sincronizo modelo == > vista, refresco la 'tableView'
